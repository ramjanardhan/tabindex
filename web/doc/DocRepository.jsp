                            ...
                            <div  style="alignment-adjust:central;" >
                                ...
                                <s:form action="../doc/documentSearch.action" method="post" name="documentForm" id="documentForm" theme="simple">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <br>    <div class="row">
                                                    ...
                                                    <div class="col-sm-3"><br>
                                                        <button  type="button" id="addButton" name="addButton" value="Add Div" class="btn btn-success"   style="margin-top:6px ;" ><i class="fa fa-plus" tabindex="11" ></i></button>
                                                ...
                                                <div id="corr1" style="display: none">
                                                    <br>   <div class="row">
                                                        ...
                                                        <div class="col-sm-3">
                                                            ...
                                                            <s:textfield cssClass="form-control" name="corrvalue2" id="corrvalue2" value="%{corrvalue2}" tabindex="16"/>
                                                        </div>
                                                    </div></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-2"><s:submit value="Search"  onclick="return checkCorrelation();"   cssClass="btn btn-primary col-sm-12" tabindex="17"/></div>
                                            <div class="col-sm-2"><strong><input type="button" value="Reset"  tabindex="17" class="btn btn-primary col-sm-12" onclick="return resetvaluesManufacteringDocRep(); " tabindex="18"/></strong></div>
                                            </td>
